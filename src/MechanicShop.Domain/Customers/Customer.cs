...
public sealed class Customer : AuditableEntity
{
    ...
    private static Result<bool> Validate(string name, string phoneNumber, string email)
    {
    ...
    public Result<Updated> SynchronizeVehicles(List<Vehicle> incomingVehicles)
    {
